...
namespace Midas.Data.Entities
{
    ...
    public partial class IexTicker
    {
        [JsonProperty("chart")]
    ...
    public partial class IexTicker
    {
        public static IexTicker FromJson(string json) => JsonConvert.DeserializeObject<IexTicker>(json, Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this IexTicker self) => JsonConvert.SerializeObject(self, Converter.Settings);
    }
